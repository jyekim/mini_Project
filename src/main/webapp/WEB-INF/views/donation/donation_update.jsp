...
<body>
  ...
  <div class="post">
    <form id="donationUpdateForm" action="/Hangeulum/donation/UpdateDonation" method="POST" enctype="multipart/form-data">a">
<!--      <form id="donationWrite" method="POST" enctype="multipart/form-data">
 -->     
       <input type="text" name="bdSeq" id="bdSeq" value="${bdSeq}" >
      ...
      <div class="form-group">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <select class="form-control" id="category" name="categorydona">
...
<!--          <div class="form-group">
        ...
        <div class="inputArea">
        	...
        	<input type="file" id="ThumbImg" name="fileu" />
        	
        	<img id="ThumbImg2" src="" />
        ...
        <button type="button" class="btn-primary" id="resetBtn" name="resetBtn" style="width: 20%; font-weight: bold">취소</button>
<%--         <a href="/Hangeulum/views/donation/donation_update?no=${data.bdseq }" role="button" class="btn-secondary">수정 </button></a>
 --%>    
        <input type="submit" value="수정" class="btn-secondary" id="modifyBtn" name="modifyBtn" style="width: 20%; font-weight: bold">수정</button>
...
<script type="text/javascript" src="http://code.jquery.com/jquery-3.6.4.min.js"></script>
<script type="text/javascript" src="../js/donation_update.js"></script> <!-- 기부게시글 작성 -->
</body>
</html>
